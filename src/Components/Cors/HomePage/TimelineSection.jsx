  ...
  return (
    <div >
		...
		<div className=' flex lg:flex-row flex-col gap-7 items-center '>
			...
			{/* LEft box */}
			<div className=' lg:w-[40%] w-[100%] items-center flex flex-col gap-6'>
				{
						...
						return (
							<div className=' flex flex-row gap-6' key={index}>
								...
								<div className=' flex flex-col '>
									<h2 className=' font-bold lg:font-semibold text-[18px]'>{element.heading}</h2>
									<h2 className=' text-xl lg:text-base'>{element.description}</h2>
